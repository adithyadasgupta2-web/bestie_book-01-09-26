  ...
  const traits = [
    {
      ...
      emoji: '🤯',
      subtitle: 'Can analyze a 2-word text for 6 consecutive hours.',
    ...
    {
      id: 2,
      title: 'Part-Time Drama Queen',
      emoji: '👑',
      subtitle: 'Oscar-nominated reactions to minor daily inconveniences.',
      color: 'from-rose-400 to-pink-600',
      bgColor: 'bg-rose-50 border-rose-200 text-rose-900',
      badge: 'ACADEMY WINNER',
    },
    {
      id: 3,
      title: 'Full-Time Food Lover',
      emoji: '🍕',
      subtitle: 'Thinks about lunch during breakfast, and dinner during lunch.',
      color: 'from-emerald-400 to-teal-600',
      bgColor: 'bg-emerald-50 border-emerald-200 text-emerald-900',
      badge: 'FOODIE SUPREME',
    },
    {
      id: 4,
      title: 'Certified Crazy Person',
      emoji: '🤪',
      subtitle: 'The only person capable of matching my exact frequency of chaos.',
